...
const { uploadFile,blogImageResize } = require('../middleware/uploadImage');
const router = express.Router();

router.get('/all', getAllBlogs)
router.get('/:id', getBlog)
router.put('/like',authMiddleware, likeBlog)
router.put('/upload/:id',authMiddleware,isAdmin, uploadFile.array('images',2),blogImageResize,uploadImages)
